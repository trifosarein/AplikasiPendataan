 ...
 * @author Basil
 */
public class AddDonatur extends javax.swing.JFrame {
    Connection con;
    Statement stat;

    /**
     * Creates new form AddDonatur
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Form Input Data Donatur");
    ...
    private void simpan_BTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpan_BTNActionPerformed
        ...
        switch (nama_TF.getText()){
            ...
            default:
                try{
                    stat.executeUpdate("insert into tb_donatur (nama_donatur,profesi_donatur,telp_donatur,alamat_donatur) values ("
                        + "'" + nama_TF.getText() +"',"
                        + "'" + profesi_TF.getText()+"',"
                        + "'" + nohp_TF.getText()+"',"
                        + "'" + alamat+ "')");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddDonatur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
